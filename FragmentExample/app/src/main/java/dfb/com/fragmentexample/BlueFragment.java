...
public class BlueFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.btn_fragment).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.onBlueFragmentButtonClick();
            }
        });
        TextView txtFragment = (TextView) view.findViewById(R.id.txt_fragment);
        txtFragment.setText(String.format("%s / %s",mParam1,mParam2));
        return view;
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onBlueFragmentButtonClick();
    }
}
